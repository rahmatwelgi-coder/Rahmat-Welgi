...
export interface AppState {
  ...
  theme?: "light" | "dark";
  lang?: "id" | "en";
  visualStyle?: "modern" | "editorial" | "playful" | "brutalist" | "warm";
  bgTheme?: string;
  profileAvatar?: string;
  profileColor?: string;
  profileMotto?: string;
  customBgImage?: string; // Base64 or image URL uploaded by user
  profileImage?: string; // Base64 or image URL uploaded by user for avatar override
  moodLog?: Record<string, number>;
  streakFreezes?: number;
  customActiveDateEnabled?: boolean;
  customActiveDate?: string; // YYYY-MM-DD format
...
export interface HistoryLog {
  ...
  details: string;
  value?: number;
  bankId?: string;       // Optional bank account ID that was deducted
  category?: string;     // Optional expense category ID
...
export interface Goal {
  ...
  linkedMetric?: {
    type: "workout_sessions" | "workout_distance_km" | "expense_savings";
